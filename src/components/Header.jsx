    ...
    <header>
      <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
        ...
        <div className="flex h-5 items-center">
          {pageName !== "video" && (
            <div
              className="flex md:hidden md:mr-6 cursor-pointer items-center justify-center h-10 w-10 rounded-full bg:bg-[#303030]/[0.6]"
        ...
        <div className="flex items-center">
          ...
          <div className="w-8 h-8 rounded-full flex items-center overflow-hidden md:ml-4">
            <img
              src="https://xsgames.co/randomusers/assets/avatars/female/28.jpg"
              alt=""
            />
          </div>
        </div>
